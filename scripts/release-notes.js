...
async function main() {
    const res = await got("https://api.github.com/repos/ludvigalden/servido/releases", {
        responseType: "json",
    });
    ...
    // Add compare link
    finalMessage.push(`https://github.com/ludvigalden/servido/compare/${firstVersion}...${lastVersion}`);
